...
export default function App() {
  ...
  // Fetch todos from currently selected backend
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col items-center py-12 px-4 selection:bg-orange-500/30">
      
      {/* Header */}
      <div className="w-full max-w-2xl mb-10 text-center space-y-4">
        <div className="inline-flex items-center gap-2 bg-orange-500/10 text-orange-400 px-3.5 py-1.5 rounded-full border border-orange-500/20 text-xs font-semibold uppercase tracking-wider">
          <Sparkles className="w-3.5 h-3.5" />
          Vite SPA Environment
        </div>
        <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
          Todo <span className="text-orange-500">Cross-Compile</span>
        </h1>
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3 rounded-xl border text-center transition-all ${
                    isSelected 
                      ? `${b.bgColor} ${b.borderColor} border-opacity-100 shadow-lg ring-1 ring-orange-500/20` 
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleCreate} className="p-5 border-b border-zinc-800 bg-zinc-900/60 flex gap-2">
            <input
              ...
              className="flex-1 bg-zinc-950 border border-zinc-800 text-white placeholder-zinc-500 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500/50 transition-all text-sm"
            />
            <button
              type="submit"
              className="bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-bold px-4 rounded-xl transition-all flex items-center justify-center shrink-0"
            >
