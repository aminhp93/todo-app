  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl shadow-xl p-6 space-y-5">
      <div className="flex items-center gap-2 text-zinc-200 font-bold text-sm">
        {mode === 'login' ? <LogIn className="w-4 h-4 text-orange-500" /> : <UserPlus className="w-4 h-4 text-orange-500" />}
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        {mode === 'register' && (
          <input
            ...
            className="w-full bg-zinc-950 border border-zinc-800 text-white placeholder-zinc-500 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500/50 transition-all text-sm"
          />
        )}
        <input
          type="email"
        ...
        <button
          ...
          className="w-full bg-orange-500 hover:bg-orange-600 active:scale-95 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all text-sm"
        >
