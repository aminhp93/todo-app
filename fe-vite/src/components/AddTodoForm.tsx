    ...
    <form onSubmit={handleSubmit} className="p-5 border-b border-zinc-800 bg-zinc-900/60">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-zinc-950 border border-zinc-800 text-white placeholder-zinc-500 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500/50 transition-all text-sm disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={!trimmed || isTooLong || disabled || isSubmitting}
          className="bg-orange-500 hover:bg-orange-600 active:scale-95 disabled:opacity-40 disabled:active:scale-100 text-white font-bold px-4 rounded-xl transition-all flex items-center justify-center shrink-0"
        >
